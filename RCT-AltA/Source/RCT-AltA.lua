--[[
	...
	---------------------------------------------------------
	Based on RCT-Altitude Announcer by Tero Salminen RC-Thoughts.com
	---------------------------------------------------------
	Released by Geierwally 11 2017
	---------------------------------------------------------
	Modified by Geierwally 05 2017 calculation of up and down
	step changed 
	---------------------------------------------------------
...
local selFt, upStep, downStep, alt, selFtIndex, selFtSt = false, 0, 0, 0
...
local function loop()
    ...
    if(sensor and sensor.valid) then
        ...
        if(swi and swi == 1 and alt >= minAlt and alt <= maxAlt) then
            ...
            if(annDn and alt < downStep and alt > 1) then
                upStep = alt + inter
                if(alt > inter)then
                	downStep = alt - inter
                else
